...
const Home = () => {
  ...
  const handleDelete = async (item) => {
    const response = await axios.post('https://blogging-backend-1-e161.onrender.com/api/articles/deletepost', { data: item });
            ...
            <div className="flex justify-between mr-10">
              ...
              <div>
                {/* <button
                  ...
                  className="border-2 border-red-400 p-2 rounded-2xl bg-red-500"
                >
                  Delete
                </button> */}
              </div>
